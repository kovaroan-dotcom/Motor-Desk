...
def main():
    ...
    def card_html(a: dict, size: str) -> str:
        ...
        return f"""
        <div class="card {size}" data-region="{html.escape(a['region'])}" data-cat="{html.escape(a['cat'])}" data-search="{html.escape(search_str)}">
          {img_block}
          <div class="cb">
            <div class="ccat">
            ...
            <div class="cf">
              ...
              {"<span class=\"xhint\">▼ read more</span>" if size == "s4" else ""}
